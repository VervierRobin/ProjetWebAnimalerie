<?php
    ...
    $pdf->cell(3,.7,'Classification',1,'C',1,1);
    $pdf->cell(8,.7,'Intitule',1,'C',1,1);
    ...
    for($i=0;$i<count($data);$i++) {
        $pdf->SetXY($x, $y);
        $pdf->cell(4,.7,$data[$i]->idnourriture,1,'C',1,1);
        $pdf->cell(5,.7,$data[$i]->idmarque_marque ,1,'C',1,1);
        $pdf->cell(3,.7,$data[$i]->idclassification_typeanimal ,1,'C',1,1);
        $pdf->cell(8,.7,$data[$i]->intitule,1,'C',1,1);  
